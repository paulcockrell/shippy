...
type VesselService interface {
	...
	GetVessels(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error)
}
...
func (c *vesselService) GetVessels(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "VesselService.GetVessels", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type VesselServiceHandler interface {
	...
	GetVessels(context.Context, *GetRequest, *Response) error
}
...
func RegisterVesselServiceHandler(s server.Server, hdlr VesselServiceHandler, opts ...server.HandlerOption) error {
	type vesselService interface {
		...
		GetVessels(ctx context.Context, in *GetRequest, out *Response) error
	}
	type VesselService struct {
		vesselService
	}
...
func (h *vesselServiceHandler) GetVessels(ctx context.Context, in *GetRequest, out *Response) error {
	return h.VesselServiceHandler.GetVessels(ctx, in, out)
}
